...
opt = lapp[[
  -n,--network       (default "/home/animesh1/asssignment1/checkpoints/fcn_10.net")          reload pretrained network
...
opt.network = '/home/animesh1/assignment1/checkpoints/fcn_10.net' -- your trained network
...
opt.resultpath =  '/home/animesh1/assignment1/results/' -- save your results here 
...
print("Path to network"..opt.network)
model = torch.load(opt.network)
model.FCN:add(nn.Exp())
model.FCN:add(nn.ReArrangeBack(opt.labelSize,opt.labelSize))
